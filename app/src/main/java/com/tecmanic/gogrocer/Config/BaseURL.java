...
public class BaseURL {
    static final String APP_NAME = "AceStore";
    ...
    public static String BASE_URL = "https://acestore.styrix.info/api/";
    public static String IMG_URL = "https://acestore.styrix.info/";
    public static String BANN_IMG_URL = "https://acestore.styrix.info/";
